...
import { ClipboardList, Calendar, MapPin, Users, Clock, ArrowLeft, CheckCircle2, UserCheck, AlertTriangle } from "lucide-react";
...
export default function ActivityDetailPage({ params }: ActivityDetailPageProps) {
  ...
  const activity = mockActivities.find((a) => a.id === resolvedParams.id) || mockActivities[0];
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title={activity.name}
        description={`Details for activity ID: ${activity.id}`}
        icon={ClipboardList}
      >
            ...
            <div className="p-3.5 border rounded-lg space-y-2">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{activity.teamLeader}</p>
                </div>
              </div>
            </div>
            <div className="p-3.5 border rounded-lg space-y-2">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">Rajinder Singh</p>
                </div>
              </div>
            </div>
          </CardContent>
